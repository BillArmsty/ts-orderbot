import { CategoryCursorListV5, ContractTypeV5, InstrumentStatusV5, OptionTypeV5, OrderSideV5 } from '../v5-shared';
/**
 ...
 */
export declare type OHLCVKlineV5 = [
    string,
    string,
    string,
    string,
 ...
 * - list[4]: closePrice	string	Close price. Is the last traded price when the candle is not closed
 */
export declare type OHLCKlineV5 = [string, string, string, string, string];
...
export declare type InstrumentInfoResponseV5 = CategoryCursorListV5<LinearInverseInstrumentInfoV5[], 'linear' | 'inverse'> | CategoryCursorListV5<OptionInstrumentInfoV5[], 'option'> | CategoryCursorListV5<SpotInstrumentInfoV5[], 'spot'>;
