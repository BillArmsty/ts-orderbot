...
class WebsocketClient extends events_1.EventEmitter {
    ...
    connect(wsKey) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const url = util_1.getWsUrl(wsKey, this.options.wsUrl, this.isTestnet(), this.logger);
    ...
    onWsMessage(event, wsKey) {
        try {
            ...
            // });
            if (util_1.isTopicSubscriptionConfirmation(msg)) {
    ...
    updatePendingTopicSubscriptionStatus(wsKey, msg) {
        ...
        if (!util_1.isTopicSubscriptionSuccess(msg)) {
